      ...
      <main className="flex-1 h-full overflow-y-auto">
        <div className="flex-1 px-6 pb-10 items-center justify-center md:justify-start text-center gap-y-8">
          <div className="max-w-4xl mx-auto mt-16">
            ...
            <footer className="mt-12 text-sm text-gray-600 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-4">
              <div className="flex flex-col items-start justify-center gap-2 mt-2">
                <div className="flex items-start mb-2">
                  <svg width="24" height="24" viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" className="mr-2">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                  ...
                  <span className="text-left">
                    ...
                    <a href="https://github.com/velvet-shark/eips-with-style" className="text-blue-500 hover:underline">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-left">
                    ...
                    <a href="https://twitter.com/velvet_shark" className="text-blue-500 hover:underline">
                      @velvet_shark
                    </a>{" "}
